...
class Calculator:
    def __init__(self, master):
        ...
        button17 = self.createButton('*2')
        button18 = self.createButton('(')
        button19 = self.createButton(')')
        button20 = self.createButton('sqrt')
        # equals with modified parameters 52 width
        button21 = self.createButton('=', None, 30)

        #button list
        buttons = [button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,button17,button18,button19,button20,button21]
        count = 0
